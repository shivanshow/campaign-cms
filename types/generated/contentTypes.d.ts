...
export interface ApiAdCreativeAdCreative extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Individual ads within a campaign';
  ...
  attributes: {
    body_copy: Schema.Attribute.Text;
    ...
    status: Schema.Attribute.Enumeration<
      ['draft', 'review', 'approved', 'rejected', 'live']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'draft'>;
    type: Schema.Attribute.Enumeration<
      ['image', 'video', 'text', 'carousel', 'story', 'banner']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiAnalyticsEventAnalyticsEvent
  ...
  info: {
    description: 'Daily performance metrics per campaign';
  ...
  attributes: {
    ...
    platform: Schema.Attribute.Enumeration<
      ['google', 'meta', 'instagram', 'linkedin', 'twitter', 'youtube', 'other']
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCampaignCampaign extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Core campaign entity';
  ...
  attributes: {
    ad_creatives: Schema.Attribute.Relation<
      'oneToMany',
      'api::ad-creative.ad-creative'
    >;
    analytics_events: Schema.Attribute.Relation<
      'oneToMany',
      'api::analytics-event.analytics-event'
    >;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    spent_budget: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    ...
    target_audience: Schema.Attribute.JSON;
...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Brands or companies running campaigns';
    displayName: 'Client';
    pluralName: 'clients';
    singularName: 'client';
  };
